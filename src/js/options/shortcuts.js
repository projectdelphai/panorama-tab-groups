...
export function enableShortcutForm(shortcut) {
		...
		document.querySelector(`#${shortcut} .updateShortcut`).removeAttribute('hidden');
		document.querySelector(`#${shortcut} .resetShortcut`).removeAttribute('hidden');
		document.querySelector(`#${shortcut} .disableShortcut`).removeAttribute('hidden');
		document.querySelector(`#${shortcut} .enableShortcut`).setAttribute('hidden', true);
}